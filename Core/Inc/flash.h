...
#define FLASH_APP_START_ADDR 0x800f800
#define FLASH_BOOT_START_ADDR 0x8000000
#define FLASH_APP_SIZE_ 0x70800
#define FLASH_APP_SIZE_ACTUAL 0x28000	//24000 + rezerva
#define FLASH_APP_VERSION_ADDR 0x0f9e0


#define BOOT_VERSION_ADDR         0x0800f700
#define BOOT_HW_REV_ADDR          0x0800f704
#define BOOT_DEVTYPE_ADDR         0x0800f708
#define BOOT_APP_MINVERSION_ADDR  0x0800f70C
